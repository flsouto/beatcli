...
//        if(!mt_rand(0,$chopchance)) $s->chop(mt_rand(50,60));
    ...
    exec('sox '.implode(' ', $out)
        ." $f repeat 3 synth triangle amod ".mt_rand(10,500)." ".mt_rand(10,90)." oops tremolo ".mt_rand(4,500)." ".mt_rand(4,99)." pitch ".mt_rand(-200,300)."  highpass 500 overdrive ".mt_rand(40,60)." tempo ".(mt_rand(80,150)/100));
    $s->file = $f;
    $len = $s->len();
    $s->delay('.2')->cut(0,$len);
    $a = $s;
